...
const About = () => {
    return (
        <div className="mx-0 md:mx-10">
            <div className="flex md:flex-row flex-col items-center gap-28 mt-16 md:mt-28 lg:mt-16">
                <div className='md:w-1/3 w-auto'>
                    <img className='shadow-lg rounded shadow-secondary' src={photo} alt="" />
                </div>
                <div className='md:w-2/3 w-auto'>
                    <h3 className='text-2xl mb-4 font-bold'>BIOGRAPHY</h3>
